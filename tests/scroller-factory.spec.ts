...
describe('Scroller factory', function () {
    it('builds normal element manager by default', function () {
        ...
        // Act
        ScrollerFactory.createFrom(descriptorMock, domManagerMock, linkerMock as ng.ITranscludeFunction, scrollDetectorMock);
        watchCallback([1, 2, 3]);
    ...
    it('can build revealer element manager', function () {
        ...
        // Act
        ScrollerFactory.createFrom(descriptorMock, domManagerMock, linkerMock, scrollDetectorMock);
